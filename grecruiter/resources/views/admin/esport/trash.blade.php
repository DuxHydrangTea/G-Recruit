                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('esport-trash.restore', $e)}}"><span class="badge bg-secondary">Restore</span></a>
                                <a href="" data-toggle="modal" data-target="#exampleModalCenter{{$e->id}}"><span class="badge bg-danger">Force Delete</span></a>
                                                   ...
                                                   <div class="modal fade" id="exampleModalCenter{{$e->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('esport-trash.force-delete', $e->id)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
