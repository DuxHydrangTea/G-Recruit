            ...
            <div class="card-body">
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$r->id}}</td>
                            <td> <img src="{{ asset('storage/images').'/'.$r->icon}}" alt="" width="30px" height="30px"> </td>
                            <td>  {{$r->rank_name}}</td>
                            <td>{{ $r->esport->esport_name}}</td>
                            <td>
                                
                                <a href="{{route('rank.edit', $r)}}"><span class="badge bg-warning">Edit</span></a>
                                                   ...
                                                   <div class="modal fade" id="exampleModalCenter{{$r->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('rank.destroy', $r)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
