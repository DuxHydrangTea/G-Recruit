...
<div class="main-content container-fluid">
    ...
    <div class="row match-height justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('rank.store')}}" class="form form-horizontal" method="POST" enctype="multipart/form-data" >
                    @csrf
                <div class="form-body">
                    <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8 form-group">
                        <input type="text" id="first-name" class="form-control" name="rank_name" >
                        @error('rank_name')
