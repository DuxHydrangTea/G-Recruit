...
<div class="main-content container-fluid">
    ...
    <div class="row match-height justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('user.store') }}" class="form form-horizontal" method="POST" enctype="multipart/form-data" >
                    @csrf
                <div class="form-body">
                    <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8 form-group">
                        <input type="text" id="first-name" class="form-control" name="nickname" >
                        @error('nickname')
                    ...
                    <div class="col-md-8 form-group">
                        <input type="date" id="first-name" class="form-control" name="birthday" >
                    ...
                    <div class="col-md-8 form-group">
                      <select name="rank_id" id="" class="form-control">
                        @foreach ($ranks as $r)
                        <option value="{{$r->id}}">{{$r->rank_name}}</option>
                        @endforeach
                    ...
                    <div class="col-md-8 form-group">
                        <input type="text" id="first-name" class="form-control" name="advantage_1" >
                    </div>
                    ...
                    <div class="col-md-8 form-group">
                        <input type="text" id="first-name" class="form-control" name="advantage_2" >
                    </div>
                    ...
                    <div class="col-md-8 form-group">
                        <input type="text" id="first-name" class="form-control" name="advantage_3" >
                    </div>
