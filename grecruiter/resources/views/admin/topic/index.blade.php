    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
               ...
               <a href="{{route('topic.create')}}"> Click here to create a new Topic </a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('topic.edit', $d)}}"><span class="badge bg-warning">Edit</span></a>
                                <a href="" data-toggle="modal" data-target="#exampleModalCenter{{$d->id}}"><span class="badge bg-danger">Remove</span></a>
                                                   ...
                                                   <div class="modal fade" id="exampleModalCenter{{$d->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        You want to delete the Esport Game: <strong>{{$d->topic_name}}</strong>?
                                                       
                                                        </div>
                                                        <div class="modal-footer">
                                                            
                                                                <form action="{{route('topic.destroy', $d)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
