                ...
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $p->description}}</td>
                            <td>{{ $p->esport->esport_name ?? ""}}</td>
                            <td>{{ $p->created_at}}</td>
                            <td>{{ $p->updated_at}}</td>
                            <td>
                                
                                <a href="{{route('position.edit', $p)}}"><span class="badge bg-warning">Edit</span></a>
                                <a href="" data-toggle="modal" data-target="#exampleModalCenter{{$p->id}}"><span class="badge bg-danger">Remove</span></a>
                                                   ...
                                                   <div class="modal fade" id="exampleModalCenter{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('position.destroy', $p)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
