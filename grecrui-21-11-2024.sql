...
-- Dumping database structure for grecruiter
CREATE DATABASE IF NOT EXISTS `grecruiter` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `grecruiter`;

-- Dumping structure for table grecruiter.applies
CREATE TABLE IF NOT EXISTS `applies` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `apply_type_id` bigint unsigned DEFAULT NULL,
  `user_id` bigint unsigned DEFAULT NULL,
  `position_id` bigint unsigned DEFAULT NULL,
  `esport_team_id` bigint unsigned DEFAULT NULL,
  `status` enum('Waiting','Accept','Deny','Pending') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'Waiting',
...
-- Dumping data for table grecruiter.applies: ~3 rows (approximately)
INSERT INTO `applies` (`id`, `apply_type_id`, `user_id`, `position_id`, `esport_team_id`, `status`, `message`, `is_read`, `created_at`, `updated_at`) VALUES
	(8, 2, 1, 6, 2, 'Waiting', 'Đội tuyển Natius Vitus 123 gửi lời mời chiêu mộ bạn!', 0, '2024-11-20 11:04:56', '2024-11-20 11:04:56'),
	(10, 2, 2, 1, 2, 'Waiting', 'Đội tuyển Natius Vitus 123 gửi lời mời chiêu mộ bạn!', 0, '2024-11-21 05:44:40', '2024-11-21 05:44:40'),
	(12, 2, 7, 6, 2, 'Waiting', 'Con chó này!', 0, '2024-11-21 06:59:55', '2024-11-21 06:59:55');

-- Dumping structure for table grecruiter.apply_types
CREATE TABLE IF NOT EXISTS `apply_types` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `type_name` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

-- Dumping data for table grecruiter.apply_types: ~2 rows (approximately)
INSERT INTO `apply_types` (`id`, `type_name`, `created_at`, `updated_at`) VALUES
	(1, 'Xin ứng tuyển', '2024-11-10 02:09:02', '2024-11-10 02:09:03'),
	(2, 'Cần tuyển dụng', '2024-11-10 02:09:15', '2024-11-10 02:09:16');
...
-- Dumping data for table grecruiter.comments: ~16 rows (approximately)
INSERT INTO `comments` (`id`, `user_id`, `post_id`, `comment_text`, `created_at`, `updated_at`) VALUES
	...
	(14, 1, 6, 'kkk', '2024-11-14 09:41:53', '2024-11-14 09:41:53'),
	(15, 1, 6, 'đâsdasdasd', '2024-11-14 09:42:01', '2024-11-14 09:42:01'),
	(16, 1, 6, 'sdasdasdas', '2024-11-14 09:42:15', '2024-11-14 09:42:15'),
	(17, 1, 6, 'ádasd', '2024-11-14 09:42:20', '2024-11-14 09:42:20'),
	(18, 1, 5, 'kakakaa', '2024-11-21 07:43:26', '2024-11-21 07:43:26'),
	(19, 1, 5, 'kkkk', '2024-11-21 07:43:42', '2024-11-21 07:43:42'),
	(20, 1, 6, 'okela', '2024-11-21 07:44:29', '2024-11-21 07:44:29');
...
CREATE TABLE IF NOT EXISTS `esport_teams` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `icon` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT '',
...
-- Dumping data for table grecruiter.esport_teams: ~1 rows (approximately)
INSERT INTO `esport_teams` (`id`, `icon`, `name`, `avatar`, `esport_id`, `description`, `deleted_at`, `created_at`, `updated_at`, `is_approved`) VALUES
	(2, '0', 'Natius Vitus 123', '/images/83_Yasuo in pixel art style, looking tough.png', 12, 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam qui unde, nisi nulla facere sint reprehenderit itaque repellendus.', NULL, '2024-09-04 08:25:07', '2024-11-19 06:41:02', 0);
...
-- Dumping data for table grecruiter.likes: ~5 rows (approximately)
INSERT INTO `likes` (`id`, `user_id`, `post_id`, `created_at`, `updated_at`) VALUES
	...
	(26, 1, 5, '2024-11-08 01:07:49', '2024-11-08 01:07:49');
...
INSERT INTO `menus` (`id`, `menu_name`, `order`, `route`, `created_at`, `updated_at`, `icon`, `type`) VALUES
	...
	(2, 'Newsfeed', 2, 'client.post.index', '2024-09-17 03:00:41', '2024-09-17 06:41:01', 'fa-solid fa-newspaper', 1),
	(7, 'Chỉnh sửa', 2, '', '2024-09-17 06:42:35', '2024-09-17 06:42:35', 'fa-solid fa-pen-to-square', 2),
	(8, 'Đăng xuất', 3, '', '2024-09-17 06:42:51', '2024-09-17 06:42:51', 'fa-solid fa-right-from-bracket', 2);
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(21, '2024_11_10_081933_create_applies_table', 8),
	(22, '2024_11_10_090350_create_apply_types_table', 9);
...
CREATE TABLE IF NOT EXISTS `topics` (
  ...
  `apply_type_id` bigint DEFAULT '0',
...
INSERT INTO `topics` (`id`, `description`, `topic_name`, `apply_type_id`, `slug`, `created_at`, `updated_at`, `esport_id`) VALUES
	(1, '0', 'Tuyển dụng game thủ chuyên nghiệp', 2, NULL, '2024-09-18 00:58:20', '2024-10-19 23:49:21', 12),
	(2, '0', 'Tuyển dụng vị trí ADC', 2, NULL, '2024-09-18 01:09:18', '2024-10-19 23:49:38', 12),
	(4, '0', 'Ứng tuyển vị trí Support', 1, NULL, '2024-10-19 23:48:18', '2024-10-19 23:48:18', 12),
	(5, '0', 'Ứng tuyển vị trí Mid', 1, NULL, '2024-10-19 23:48:30', '2024-10-19 23:48:30', 12),
	(6, '0', 'Ứng tuyển vị trí HLV', 1, NULL, '2024-10-19 23:48:46', '2024-10-19 23:48:46', 12),
	(7, '0', 'Ứng tuyển vị trí Top Laner', 1, NULL, '2024-10-19 23:48:57', '2024-10-19 23:48:57', 12),
	(8, '0', 'Ứng tuyển vị trí ADC', 1, NULL, '2024-10-19 23:49:07', '2024-10-19 23:49:07', 12),
	(9, '0', 'Ứng tuyển vị trí HLV múa lửa', 1, NULL, '2024-10-20 00:09:47', '2024-10-20 00:20:16', 12),
	(10, '0', 'Tuyển dụng Phân tích viên', 2, NULL, '2024-10-20 00:16:56', '2024-10-20 00:20:34', 12);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `avatar` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  ...
  `esport_team_id` bigint DEFAULT '0',
  `bio` text COLLATE utf8mb3_unicode_ci,
  `color` varchar(10) COLLATE utf8mb3_unicode_ci DEFAULT '#000',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` (`id`, `email`, `name`, `password`, `phone`, `address`, `avatar`, `birthday`, `esport_id`, `nickname`, `rank_id`, `rank_points`, `position_id`, `advantage_1`, `advantage_2`, `advantage_3`, `is_admin`, `deleted_at`, `created_at`, `updated_at`, `remember_token`, `esport_team_id`, `bio`, `color`) VALUES
	(1, 'ngocdung2002d@gmail.com', 'Nguyễn Ngọc Dũng', '$2y$12$RvhSm/tQJimlUdk53Wb6ju89fguRZnQYcMWNivo8qFvK1TiMzRuGG', '0234442555', 'Xóm 1 Quỳnh Châu Quỳnh Lưu \r\ntỉnh Nghệ An', '453514655_1038246637703242_3169082358294790999_n.jpg', '2002-01-18', 12, 'SK T1 Hasmesd', 9, 400, 6, 'Ưu điểm 1 là quá đẹp trai\r\nCùng với sự xuất sắc ở đây!', 'Ưu điểm 2 là chơi game giỏi', 'Ưu điểm 3 là vip pro', 0, NULL, '2024-08-29 06:42:58', '2024-11-19 10:47:11', 'B95SdM8siT4SdJ2F4qG7GdghatjELz2dtbDxK3lMwE4rdCsi2eEaRvlDABJ6', 2, 'Anh tài Tự Long chụp ảnh với nhạc sĩ Doãn Nho tác giả bài hát Chiếc Khăn Piêu. Nhạc sĩ Doãn Nho cũng rất thích Chiếc Khăn Piêu phiên bản Nhà Cá Lớn ở ATVNCG.\r\n\r\nSáng nay, Đại tá, NSND Tự Long cùng Đại tá, nhạc sĩ Doãn Nho cũng luyện tập chuẩn bị cho chuỗi hoạt động của đại lễ kỷ niệm 80 năm ngày thành lập Quân Đội Nhân Dân Việt Nam tại bảo tàng Lịch sử quân sự Việt Nam.', '#0b2d76'),
	(2, 'n2d@gmail.comm', 'Peter Hugo', '$2y$12$RvhSm/tQJimlUdk53Wb6ju89fguRZnQYcMWNivo8qFvK1TiMzRuGG', '0368225832', 'TRường trung học phổ thông quỳnh lưu 4', 'IMG_5882.PNG', '2024-09-08', 12, 'SSG Viktor', 9, 0, 1, '111111', 'aaaaaaaaaaaaaaaa', 'asdasda', 0, NULL, '2024-09-04 19:48:14', '2024-09-17 23:59:57', 'Pk6y4ehI62924I2nwnHko0KtWgZGecSu4pevgYecGMfSr28n1T1p9KgtxXof', 0, NULL, '#ef30c2'),
	(3, 'ndasdad02d@gmail.com', 'asdadsdadsa', '$2y$12$RvhSm/tQJimlUdk53Wb6ju89fguRZnQYcMWNivo8qFvK1TiMzRuGG', '1234566541', NULL, 'IMG_5882.PNG', NULL, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, 1, NULL, '2024-09-15 11:37:10', '2024-09-15 11:37:10', NULL, 0, NULL, '#751297'),
	(4, 'asdadg2002d@gmail.com', 'Ngọc Dũng', '$2y$12$RvhSm/tQJimlUdk53Wb6ju89fguRZnQYcMWNivo8qFvK1TiMzRuGG', '0362225831', NULL, '453514655_1038246637703242_3169082358294790999_n.jpg', NULL, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, 1, NULL, '2024-09-15 20:05:03', '2024-09-15 20:05:03', NULL, 0, NULL, '#ef30c2'),
	(5, 'ngoc.dung.304.1975@gmail.com', 'Duxng CACA', '$2y$12$RvhSm/tQJimlUdk53Wb6ju89fguRZnQYcMWNivo8qFvK1TiMzRuGG', '0368115131', NULL, 'IMG_5882.PNG', NULL, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, 1, NULL, '2024-09-15 20:15:21', '2024-09-15 20:15:21', NULL, 0, NULL, '#000'),
	(6, 'fakernguyen5831@gmail.com', 'Lee Sang Hyuk', '$2y$12$RvhSm/tQJimlUdk53Wb6ju89fguRZnQYcMWNivo8qFvK1TiMzRuGG', '0362222831', 'TRường trung học phổ thông quỳnh lưu 4', 'post1.jpg', '2024-09-05', 12, 'DWG Madlife', 1, 0, 1, 'dasda', 'asdasdasd', 'aasdadadsas', 0, NULL, '2024-09-18 00:00:53', '2024-09-18 00:00:53', NULL, 0, NULL, '#38390f'),
	(7, 'ngocddfedd@gmail.com', 'HaoShen', '$2y$12$RvhSm/tQJimlUdk53Wb6ju89fguRZnQYcMWNivo8qFvK1TiMzRuGG', '0333325831', 'TRường trung học phổ thông quỳnh lưu 4', '1293302.jpg', '2024-09-22', 12, 'PLW Katatta', 1, 0, 1, 'dasda', 'dasdasd', 'dasda', 0, NULL, '2024-09-18 00:01:42', '2024-09-18 00:01:42', NULL, 0, NULL, '#751297');
